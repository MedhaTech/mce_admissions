                      ...
                      <div class="form-row">
                          <div class="col-md-3 col-sm-6">
                              <div class="form-group">
                                  ...
                                  <input type="text" name="total_obtained_marks[]" id="total_obtained_marks[]" class="form-control" readonly>

                              </div>
                          </div>
                          <div class="col-md-3 col-sm-6">
                              <div class="form-group">
                                  <label class="label">Maximun Marks</label>
                                  <input type="text" name="total_max_marks[]" id="total_max_marks[]" class="form-control" readonly>
                          ...
                          <div class="form-row">
                              ...
                              <div class="col-md-3 col-sm-6">
                                  <div class="form-group">
                                      ...
                                      <input type="text" name="examination" id="examination" value="<?php echo (set_value('examination')) ? set_value('examination') : $examination; ?>" class="form-control" placeholder="Enter Examination">
                                      <span class="text-danger"><?php echo form_error('examination'); ?></span>
                                  </div>
                              </div>
                          ...
                          <table class="table" border="1">
                              ...
                              <tbody>
                                  ...
                                  <tr>
                                      <th>I year</th>
                                      <td>
                                          <input type="number" name="subject_1_min_marks[]" id="subject_1_min_marks[]" class="form-control" placeholder="Enter Obtained Marks" value="<?php echo (set_value('subject_1_min_marks[]')) ? set_value('subject_1_min_marks[]') : ''; ?>">
                                          <span class="text-danger"><?php echo form_error('subject_1_min_marks[]'); ?></span>
                                      </td>
                                      <td>
                                          <input type="number" name="subject_1_max_marks[]" id="subject_1_max_marks[]" class="form-control" placeholder="Enter Max Marks" value="<?php echo (set_value('subject_1_max_marks[]')) ? set_value('subject_1_max_marks[]') : ''; ?>">
                                      ...
                                      <td>
                                          <input type="number" name="subject_1_obtained_marks[]" id="subject_1_obtained_marks[]" class="form-control" value="<?php echo (set_value('subject_1_obtained_marks[]')) ? set_value('subject_1_obtained_marks[]') : ''; ?>">
                                          <span class="text-danger"><?php echo form_error('subject_1_obtained_marks[]'); ?></span>
                                      </td>
                                  </tr>
                                  <!-- Subject 2 -->
                                  <tr>
                                      <th>II Year</th>
                                      <td>
                                          <input type="number" name="subject_2_min_marks[]" id="subject_2_min_marks[]" class="form-control" placeholder="Enter Obtained Marks" value="<?php echo (set_value('subject_2_min_marks[]')) ? set_value('subject_2_min_marks[]') : ''; ?>">
                                          <span class="text-danger"><?php echo form_error('subject_2_min_marks[]'); ?></span>
                                      </td>
                                      <td>
                                          <input type="number" name="subject_2_max_marks[]" id="subject_2_max_marks[]" class="form-control" placeholder="Enter Max Marks" value="<?php echo (set_value('subject_2_max_marks[]')) ? set_value('subject_2_max_marks[]') : ''; ?>">
                                      ...
                                      <td>
                                          <input type="number" name="subject_2_obtained_marks[]" id="subject_2_obtained_marks[]" class="form-control" value="<?php echo (set_value('subject_2_obtained_marks[]')) ? set_value('subject_2_obtained_marks[]') : ''; ?>">
                                          <span class="text-danger"><?php echo form_error('subject_2_obtained_marks[]'); ?></span>
                                      </td>
                                  </tr>
                                  <!-- Subject 3 -->
                                  <tr>
                                      <th>III Year</th>
                                      <td>
                                          <input type="number" name="subject_3_min_marks[]" id="subject_3_min_marks[]" class="form-control" placeholder="Enter Obtained Marks" value="<?php echo (set_value('subject_3_min_marks[]')) ? set_value('subject_3_min_marks[]') : ''; ?>">
                                          <span class="text-danger"><?php echo form_error('subject_3_min_marks[]'); ?></span>
                                      </td>
                                      <td>
                                          <input type="number" name="subject_3_max_marks[]" id="subject_3_max_marks[]" class="form-control" placeholder="Enter Max Marks" value="<?php echo (set_value('subject_3_max_marks[]')) ? set_value('subject_3_max_marks[]') : ''; ?>">
                                      ...
                                      <td>
                                          <input type="number" name="subject_3_obtained_marks[]" id="subject_3_obtained_marks[]" class="form-control" value="<?php echo (set_value('subject_3_obtained_marks[]')) ? set_value('subject_3_obtained_marks[]') : ''; ?>">
                                          <span class="text-danger"><?php echo form_error('subject_3_obtained_marks[]'); ?></span>
                                      </td>
                                  </tr>
                              </tbody>
                          ...
                          <table class="table" border="1">
                              ...
                              <tbody>
                                  ...
                                  <tr>
                                      <th>IV Year</th>
                                      <td>
                                          <input type="number" name="subject_4_min_marks[]" id="subject_4_min_marks[]" class="form-control" placeholder="Enter Obtained Marks" value="<?php echo (set_value('subject_4_min_marks[]')) ? set_value('subject_4_min_marks[]') : ''; ?>">
                                          <span class="text-danger"><?php echo form_error('subject_4_min_marks[]'); ?></span>
                                      </td>
                                      <td>
                                          <input type="number" name="subject_4_max_marks[]" id="subject_4_max_marks[]" class="form-control" placeholder="Enter Max Marks" value="<?php echo (set_value('subject_4_max_marks[]')) ? set_value('subject_4_max_marks[]') : ''; ?>">
                                      ...
                                      <td>
                                          <input type="number" name="subject_4_obtained_marks[]" id="subject_4_obtained_marks[]" class="form-control" value="<?php echo (set_value('subject_4_obtained_marks[]')) ? set_value('subject_4_obtained_marks[]') : ''; ?>">
                                          <span class="text-danger"><?php echo form_error('subject_4_obtained_marks[]'); ?></span>
                                      </td>
                                  </tr>
                              </tbody>
