            ...
            <div class="row">
             <div class="col-md-3 col-sm-12">    
                  <div class="form-group">
                    ...
                    <input type=".$newDate." class="form-control" placeholder="Enter DOB" id="date_of_birth" value="<?php echo (set_value('date_of_birth')) ? set_value('date_of_birth') : $date_of_birth; ?>" name="date_of_birth">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Enter Sports" id="gender" value="<?php echo (set_value('gender')) ? set_value('gender') : $gender; ?>" name="gender">
                <span
            ...
            <div class="row">
              ...
              <div class="col-md-3 col-sm-12">    
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Nationality" id="nationality" value="<?php echo (set_value('nationality')) ? set_value('nationality') : $nationality; ?>" name="nationality">
              ...
              <div class="col-md-3 col-sm-12">    
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Disability" id="disability" value="<?php echo (set_value('disability')) ? set_value('disability') : $disability; ?>" name="disability">
              ...
              <div class="col-md-3 col-sm-12">    
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Type of Disability" id="type_of_disability" value="<?php echo (set_value('type_of_disability')) ? set_value('type_of_disability') : $type_of_disability; ?>" name="type_of_disability">
              ...
              <div class="col-md-3 col-sm-12">    
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Economically Backward" id="economically_backward" value="<?php echo (set_value('economically_backward')) ? set_value('economically_backward') : $economically_backward; ?>" name="economically_backward">
              ...
              <div class="col-md-3 col-sm-12">    
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Economically Backward" id="domicile_of_state" value="<?php echo (set_value('domicile_of_state')) ? set_value('domicile_of_state') : $domicile_of_state; ?>" name="domicile_of_state">
              ...
              <div class="col-md-3 col-sm-12">    
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Hobbies" id="hobbies" value="<?php echo (set_value('hobbies')) ? set_value('hobbies') : $hobbies; ?>" name="hobbies">
            ...
            <div class="row">
              <div class="col-md-6">    
                  ...
                  <label class="form-label">Current Address</label>
                    <input type="text" class="form-control" placeholder="Enter Current Address" id="current_address" value="<?php echo (set_value('current_address')) ? set_value('current_address') : $current_address; ?>" name="current_address">
    		            <span class="text-danger"><?php echo form_error('current_address'); ?></span>
                  </div>
                  <div class="form-group col-md-12 col-sm-12">    
                    <label class="form-label">Current City</label>
                    <input type="text" class="form-control" placeholder="Enter Current City" id="current_city" value="<?php echo (set_value('current_city')) ? set_value('current_city') : $current_city; ?>" name="current_city">
    		            <span class="text-danger"><?php echo form_error('current_city'); ?></span>
                  </div>
                  <div class="form-group col-md-12 col-sm-12">    
                    <label class="form-label">Current District</label>
                    <input type="text" class="form-control" placeholder="Enter Current State" id="current_district" value="<?php echo (set_value('current_district')) ? set_value('current_district') : $current_district; ?>" name="current_district">
    		            <span class="text-danger"><?php echo form_error('current_district'); ?></span>
                  </div>
                  <div class="form-group col-md-12 col-sm-12">    
                    <label class="form-label">Current State</label>
                    <input type="text" class="form-control" placeholder="Enter Current State" id="current_state" value="<?php echo (set_value('current_state')) ? set_value('current_state') : $current_state; ?>" name="current_state">
    		            <span class="text-danger"><?php echo form_error('current_state'); ?></span>
                  </div>
                  <div class="form-group col-md-12 col-sm-12">    
                  <label class="form-label">Current Country</label>
                    <input type="text" class="form-control" placeholder="Enter Current Country" id="current_country" value="<?php echo (set_value('current_country')) ? set_value('current_country') : $current_country; ?>" name="current_country">
    		            <span class="text-danger"><?php echo form_error('current_country'); ?></span>
                  </div>
                  <div class="form-group col-md-12 col-sm-12">    
                  <label class="form-label">Current Pincode</label>
                    <input type="text" class="form-control" placeholder="Enter Current Pincode" id="current_pincode" value="<?php echo (set_value('current_pincode')) ? set_value('current_pincode') : $current_pincode; ?>" name="current_pincode">
              ...
              <div class="col-md-6">    
                  ...
                  <label class="form-label">Permanent Address</label>
                    <input type="text" class="form-control" placeholder="Enter Permanent Address" id="present_address" value="<?php echo (set_value('present_address')) ? set_value('present_address') : $present_address; ?>" name="present_address">
    		            <span class="text-danger"><?php echo form_error('present_address'); ?></span>
                  </div>
                  <div class="form-group col-md-12 col-sm-12">    
                   <label class="form-label">Permanent City</label>
                    <input type="text" class="form-control" placeholder="Enter Permanent State" id="present_city" value="<?php echo (set_value('present_city')) ? set_value('present_city') : $present_city; ?>" name="present_city">
    		            <span class="text-danger"><?php echo form_error('present_city'); ?></span>
                   </div>
                   <div class="form-group col-md-12 col-sm-12">    
                   <label class="form-label">Permanent District</label>
                    <input type="text" class="form-control" placeholder="Enter Permanent State" id="present_district" value="<?php echo (set_value('present_district')) ? set_value('present_district') : $present_district; ?>" name="present_district">
    		            <span class="text-danger"><?php echo form_error('present_district'); ?></span>
                   </div>
                  <div class="form-group col-md-12 col-sm-12">    
                  <label class="form-label">Permanent State</label>
                    <input type="text" class="form-control" placeholder="Enter Permanent State" id="present_state" value="<?php echo (set_value('present_state')) ? set_value('present_state') : $present_state; ?>" name="present_state">
    		            <span class="text-danger"><?php echo form_error('present_state'); ?></span>
                  </div>
                  <div class="form-group col-md-12 col-sm-12">    
                  <label class="form-label">Permanent Country</label>
                    <input type="text" class="form-control" placeholder="Enter Permanent Country" id="present_country" value="<?php echo (set_value('present_country')) ? set_value('present_country') : $present_country; ?>" name="present_country">
    		            <span class="text-danger"><?php echo form_error('present_country'); ?></span>
                  </div>
                  <div class="form-group col-md-12 col-sm-12">    
                    <label class="form-label">Permanent Pincode</label>
                    <input type="text" class="form-control" placeholder="Enter Permanent Pincode" id="present_pincode" value="<?php echo (set_value('present_pincode')) ? set_value('present_pincode') : $present_pincode; ?>" name="present_pincode">
