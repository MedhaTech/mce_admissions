                ...
                <div class="card-body">
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select name="country_of_birth" id="country_of_birth"
                                    ...
                                    <?php foreach ($countries as $country): ?>
                                        ...
                                        ?>
                                        <option data-id="<?= $country->id ?>" value="<?= $country->name ?>" <?= $selected ?>>
                                            <?= $country->name ?></option>
                                    <?php endforeach; ?>
                                </select>
                        ...
                        <div class="col-md-3 col-sm-12 yes">
                            <div class="form-group">
                                <label class="labeldis" id="type_of_disability1" name="type_of_disability1">Type of
                                    Disability</label>
                                ...
                                <div class="form-group col-md-12 col-sm-12">
                                    ...
                                    <select name="current_state" id="current_state"
                                        ...
                                        <?php foreach ($states1 as $state): ?>
                                            ...
                                            ?>
                                            <option data-id="<?= $state->id ?>" value="<?= $state->name ?>" <?= $selected ?>>
                                                <?= $state->name ?></option>
                                        <?php endforeach; ?>
                                    </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group row m-0">
                                ...
                                <div class="col-md-6 custom-control custom-checkbox">
                                    ...
                                    <label class="form-label custom-control-label" for="customCheck1">Same As Current
                                        Address</label>
                                </div>
                            </div>
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6 col-sm-12">
                                    <label class="form-label">Country</label>
                                    <select name="present_country" id="present_country"
                                        class="form-control input-lg select2">
                                        <option>Select Country</option>
                                        <?php foreach ($countries as $country): ?>
                                            <?php
