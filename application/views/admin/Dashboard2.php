                                ...
                                <table class="table table-hover text-center">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class='text-center align-middle' width="12%">COMED-K <br /> UNFILLED
                                            </th>
                                            <th class='text-center align-middle' width="12%">MGMT-COMEDK <br /> INTAKE
                                                </br><span style="font-size: 9px;">(MOVED FROM PRINCIPAL LOGIN)</span>
                                            </th>
                                            <!-- <span style="font-size: 10px;">(NUMBER OF UNFILLED SEATS MOVED FROM PRINCIPAL LOGIN)</span> -->
                                            <th class='text-center align-middle' width="12%">MGMT-COMEDK <br />
                                                ENDORSMENT
                                                ISSUED</th>
                                            <th class='text-center align-middle' width="12%">MGMT-COMEDK <br /> ADMITTED
                                            </th>
                                            <th class='text-center align-middle' width="12%">MGMT-COMEDK <br /> UNFILLED
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        $MGMT_COMEDK_ENDORSE_UNAIDED_TOTAL = 0;
                                        $MGMT_ENDORSE_UNAIDED_TOTAL = 0;
                                        ...
                                        foreach ($unaidedmgmt as $unaidedmgmt1) {
                                            ...
                                            echo "<td class='bg-danger-light'>" . $COMEDK_VACANT . "</td>";
                                            ...
                                            $MGMT_COMEDK_ENDORSE_UNAIDED = $this->admin_model->getEndorsmentStats($department_id, 'MGMT-COMEDK', 'UnAided')->row()->cnt;
                                            echo "<td class='bg-danger-light'>" . $MGMT_COMEDK_ENDORSE_UNAIDED . "</td>";
                                            $MGMT_COMEDK_ENDORSE_UNAIDED_TOTAL = $MGMT_COMEDK_ENDORSE_UNAIDED_TOTAL + $MGMT_COMEDK_ENDORSE_UNAIDED;

                                            $MGMT_COMEDK_UNAIDED = $this->admin_model->getAdmissionStats1($department_id, 'MGMT-COMEDK', 'UnAided')->row()->cnt;
                                            ...
                                            $MGMT_COMEDK_VACANT = $unaidedmgmt1->moved - $MGMT_COMEDK_UNAIDED - $MGMT_COMEDK_ENDORSE_UNAIDED;
                                        ...
                                        echo "<th class='bg-danger-light'>" . $COMEDK_VACANT_TOTAL . "</th>";
                                        echo "<th class='bg-gray-light'>" . $MOVED_TOTAL . "</th>";
                                        echo "<th class='bg-danger-light'>" . $MGMT_COMEDK_ENDORSE_UNAIDED_TOTAL . "</th>";
