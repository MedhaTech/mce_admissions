          ...
          $("#get_details").click(function() {
              ...
              if (report == "1") {
                  $.ajax({
                      ...
                      'success': function(data) {
                          var filename = "All Enquiries Report.xls";
                          var $a = $("<a>");
              ...
              if (report == "2") {
                  $.ajax({
                      ...
                      'cache': false,
                      'success': function(data) {
                          var filename = "More than 45% PUC Enquiries Report.xls";
                          var $a = $("<a>");
                          $a.attr("href", data.file);
                          $("body").append($a);
                          $a.attr("download", filename);
              ...
              if (report == "3") {
                  $.ajax({
                      ...
                      'cache': false,
                      'success': function(data) {
                          var filename = "Less than 45% PUC Enquiries Report.xls";
                          var $a = $("<a>");
                          $a.attr("href", data.file);
                          $("body").append($a);
                          $a.attr("download", filename);
              ...
              if (report == "4") {
                  $.ajax({
                      ...
                      'cache': false,
                      'success': function(data) {
                          var filename = "PUC % wise Enquiries Report.xls";
                          var $a = $("<a>");
                          $a.attr("href", data.file);
                          $("body").append($a);
                          $a.attr("download", filename);
