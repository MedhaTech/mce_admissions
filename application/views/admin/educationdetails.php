          ...
          <div class="container-fluid">
              ...
              <div class="card card-info shadow mb-2">
                  <?php if (count($educations_details) == 0) { ?>
                              ...
                              <div class="col-md-3 col-sm-6">
                                  ...
                                  <label class="label">Institution Country</label>
                                    ...
                                    <select name="inst_country" id="inst_country" class="form-control input-lg select2">
                                        <option value="" <?= $selected_country === '' ? 'selected' : '' ?>>Select Country</option>
                                        <?php foreach ($countries as $country) : ?>
                                            <option data-id="<?= $country->id ?>" value="<?= $country->name ?>" <?= $selected_country === $country->name ? 'selected' : '' ?>>
                                                <?= $country->name ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                          ...
                          <div class="form-row">
                              <div class="col-md-3 col-sm-6">
                                  <div class="form-group">
                                      ...
                                      <input type="text" name="total_obtained_marks" id="total_obtained_marks" class="form-control" value="<?php echo (set_value('total_obtained_marks')) ? set_value('total_obtained_marks') : ''; ?>" readonly>
                              ...
                              <div class="col-md-3 col-sm-6">
                                  <div class="form-group">
                                      ...
                                      <input type="text" name="total_max_marks" id="total_max_marks" class="form-control" value="<?php echo (set_value('total_max_marks')) ? set_value('total_max_marks') : ''; ?>" readonly>
                              ...
                              <div class="col-md-3 col-sm-6">
                                  <div class="form-group">
                                      ...
                                      <input type="text" name="aggregate" id="aggregate" class="form-control" value="<?php echo (set_value('aggregate')) ? set_value('aggregate') : ''; ?>" readonly>
                          ...
                          <div class="card-body" id="card1">
                              ...
                              <div class="form-row">
                                  ...
                                  <div class="col-md-4 col-sm-6">
                                      <div class="form-group">
                                          <label class="label">Board / University</label>
                                          <input type="text" name="puc_inst_board" id="puc_inst_board" value="<?php echo (set_value('puc_inst_board')) ? set_value('puc_inst_board') : $puc_inst_board; ?>" class="form-control" placeholder="Enter Institution Board">
                                  ...
                                  <div class="col-md-4 col-sm-6">
                                      <div class="form-group">
                                          <label class="label">Institution Name</label>
                                          <input type="text" name="puc_inst_name" id="puc_inst_name" value="<?php echo (set_value('puc_inst_name')) ? set_value('puc_inst_name') : $puc_inst_name; ?>" class="form-control" placeholder="Enter Institution Name">
                              ...
                              <div class="form-row">
                                  <div class="col-md-3 col-sm-6">
                                      <div class="form-group">
                                          <label class="label">Institution Address</label>
                                          <input type="text" name="puc_inst_address" id="puc_inst_address" value="<?php echo (set_value('puc_inst_address')) ? set_value('puc_inst_address') : $puc_inst_address; ?>" class="form-control" placeholder="Enter Institution Address">
                                  ...
                                  <div class="col-md-3 col-sm-6">
                                      <div class="form-group">
                                          ...
                                          <select name="puc_inst_country" id="puc_inst_country" class="form-control input-lg select2">
                              ...
                              <div class="form-row">
                                  ...
                                  <div class="col-md-3 col-sm-6">
                                      <div class="form-group">
                                          <label class="label">Year of Passing</label>
                                          <input type="month" name="puc_year_of_passing" value="<?php echo (set_value('puc_year_of_passing')) ? set_value('puc_year_of_passing') : $puc_year_of_passing; ?>" id="puc_year_of_passing" class="form-control" placeholder="Enter School Year">
                              ...
                              <table class="table" border="1">
                                  ...
                                  <tbody>
                                      ...
                                      <tr>
                                          <td>
                                              <input type="text" name="puc_subject_1_name" id="puc_subject_1_name" class="form-control" placeholder="Enter Subject Name" value="<?php echo (set_value('puc_subject_1_name')) ? set_value('puc_subject_1_name') : ''; ?>">
                                          ...
                                          <td>
                                              ...
                                              <span class="text-danger"><?php echo form_error('puc_subject_1_obtained_marks'); ?></span>
                                          </td>
                                      </tr>
                                      <!-- Subject 2 -->
                                      <tr>
                                          <td>
                                              <input type="text" name="puc_subject_2_name" id="puc_subject_2_name" class="form-control" placeholder="Enter Subject Name" value="<?php echo (set_value('puc_subject_2_name')) ? set_value('puc_subject_2_name') : ''; ?>">
                                          ...
                                          <td>
                                              ...
                                              <span class="text-danger"><?php echo form_error('puc_subject_2_obtained_marks'); ?></span>
                                          </td>
                                      </tr>
                                      <!-- Subject 3 -->
                                      <tr>
                                          <td>
                                              <input type="text" name="puc_subject_3_name" id="puc_subject_3_name" class="form-control" placeholder="Enter Subject Name" value="<?php echo (set_value('puc_subject_3_name')) ? set_value('puc_subject_3_name') : ''; ?>">
                                          ...
                                          <td>
                                              ...
                                              <span class="text-danger"><?php echo form_error('puc_subject_3_obtained_marks'); ?></span>
                                          </td>
                                      </tr>
                                      <!-- Subject 4 -->
                                      <tr>
                                          <td>
                                              <input type="text" name="puc_subject_4_name" id="puc_subject_4_name" class="form-control" placeholder="Enter Subject Name" value="<?php echo (set_value('puc_subject_4_name')) ? set_value('puc_subject_4_name') : ''; ?>">
                                          ...
                                          <td>
                                              ...
                                              <span class="text-danger"><?php echo form_error('puc_subject_4_obtained_marks'); ?></span>
                                          </td>
                                      </tr>
                                      <!-- Subject 5 -->
                                      <tr>
                                          <td>
                                              <input type="text" name="puc_subject_5_name" id="puc_subject_5_name" class="form-control" placeholder="Enter Subject Name" value="<?php echo (set_value('puc_subject_5_name')) ? set_value('puc_subject_5_name') : ''; ?>">
                                          ...
                                          <td>
                                              ...
                                              <span class="text-danger"><?php echo form_error('puc_subject_5_obtained_marks'); ?></span>
                                          </td>
                                      </tr>
                                      <!-- Subject 6 -->
                                      <tr>
                                          <td>
                                              <input type="text" name="puc_subject_6_name" id="puc_subject_6_name" class="form-control" placeholder="Enter Subject Name" value="<?php echo (set_value('puc_subject_6_name')) ? set_value('puc_subject_6_name') : ''; ?>">
                                          ...
                                          <td>
                                              ...
                                              <span class="text-danger"><?php echo form_error('puc_subject_6_obtained_marks'); ?></span>
                                          </td>
                                      </tr>
                                  </tbody>
                                  <!-- <tfoot>
                              ...
                              <div class="form-row">
                                  <div class="col-md-3 col-sm-6">
                                      <div class="form-group">
                                          <label class="label">Obtained Marks</label>
                                          <input type="text" name="puc_total_obtained_marks" id="puc_total_obtained_marks" value="<?php echo (set_value('puc_total_obtained_marks')) ? set_value('puc_total_obtained_marks') : ''; ?>" class="form-control" readonly>
                                  ...
                                  <div class="col-md-3 col-sm-6">
                                      <div class="form-group">
                                          <label class="label">Maximum Marks</label>
                                          <input type="text" name="puc_total_max_marks" id="puc_total_max_marks" value="<?php echo (set_value('puc_total_max_marks')) ? set_value('puc_total_max_marks') : ''; ?>" class="form-control" readonly>
                                  ...
                                  <div class="col-md-3 col-sm-6">
                                      <div class="form-group">
                                          <label class="label">Aggregate Percentage</label>
                                          <input type="text" name="puc_aggregate" id="puc_aggregate" value="<?php echo (set_value('puc_aggregate')) ? set_value('puc_aggregate') : ''; ?>" class="form-control" readonly>
                      ...
                      <?php } ?>
                      <?php if ($personalDetails->admission_based == "Diploma" && $personalDetails->lateral_entry == "DIPLOMA") { ?>
                          <div class="card-body" id="card2">
                              ...
                              <div class="form-row">
                                  ...
                                  <div class="col-md-4 col-sm-6">
                                      <div class="form-group">
                                          <label class="label">Board / University</label>
                                          <input type="text" name="diploma_inst_board" id="diploma_inst_board" value="<?php echo (set_value('diploma_inst_board')) ? set_value('diploma_inst_board') : $diploma_inst_board; ?>" class="form-control" placeholder="Enter Institution Board">
                                  ...
                                  <div class="col-md-4 col-sm-6">
                                      <div class="form-group">
                                          <label class="label">Institution Name</label>
                                          <input type="text" name="diploma_inst_name" id="diploma_inst_name" value="<?php echo (set_value('diploma_inst_name')) ? set_value('diploma_inst_name') : $diploma_inst_name; ?>" class="form-control" placeholder="Enter Institution Name">
                              ...
                              <div class="form-row">
                                  <div class="col-md-3 col-sm-6">
                                      <div class="form-group">
                                          <label class="label">Institution Address</label>
                                          <input type="text" name="diploma_inst_address" id="diploma_inst_address" value="<?php echo (set_value('diploma_inst_address')) ? set_value('diploma_inst_address') : $diploma_inst_address; ?>" class="form-control" placeholder="Enter Institution Address">
                                  ...
                                  <div class="col-md-3 col-sm-6">
                                      <div class="form-group">
                                          ...
                                          <select name="diploma_inst_country" id="diploma_inst_country" class="form-control input-lg select2">
                                              <option selected="">Select Country</option>
                                              <?php foreach ($countries as $country) : ?>
                                                  <option data-id="<?= $country->id ?>" value="<?= $country->name ?>"><?= $country->name ?></option>
                                              <?php endforeach; ?>
                                  ...
                                  <div class="col-md-3 col-sm-6">
                                      <div class="form-group">
                                          ...
                                          <select name="diploma_inst_state" id="diploma_inst_state" class="form-control input-lg select2">
                                              <option value="">Select State</option>
                                          </select>
                                  ...
                                  <div class="col-md-3 col-sm-6">
                                      <div class="form-group">
                                          ...
                                          <label class="label">Institution City</label>
                                          <select name="diploma_inst_city" id="diploma_inst_city" class="form-control input-lg select2">
                                              <option value="">Select City</option>
                                          </select>
                              ...
                              <div class="form-row">
                                  <div class="col-md-3 col-sm-6">
                                      <div class="form-group">
                                          ...
                                          <span class="text-danger"><?php echo form_error('diploma_medium_of_instruction'); ?></span>
                                      </div>
                                  </div>
                                  <div class="col-md-3 col-sm-6">
                                      <div class="form-group">
                                  ...
                                  <div class="col-md-3 col-sm-6">
                                      <div class="form-group">
                                          <label class="label">Year of Passing</label>
                                          <input type="month" name="diploma_year_of_passing" value="<?php echo (set_value('diploma_year_of_passing')) ? set_value('diploma_year_of_passing') : $diploma_year_of_passing; ?>" id="diploma_year_of_passing" class="form-control" placeholder="Enter School Year">
                              ...
                              <table class="table" border="1">
                                  ...
                                  <tbody>
                                      <!-- Subject 1 -->
                                      <tr>
                                          <th><input type="text" name="diploma_subject_1_name" id="diploma_subject_1_name" class="form-control font-weight-bold" placeholder="I year" value="I year" readonly></th>
                                          <td>
                                              <input type="number" name="diploma_subject_1_obtained_marks" id="diploma_subject_1_obtained_marks" class="form-control" placeholder="Enter Obtained Marks" value="<?php echo (set_value('diploma_subject_1_obtained_marks')) ? set_value('diploma_subject_1_obtained_marks') : ''; ?>">
                                              <span class="text-danger"><?php echo form_error('diploma_subject_1_obtained_marks'); ?></span>
                                          </td>
                                          <td>
                                              <input type="number" name="diploma_subject_1_max_marks" id="diploma_subject_1_max_marks" class="form-control" placeholder="Enter Max Marks" value="<?php echo (set_value('diploma_subject_1_max_marks')) ? set_value('diploma_subject_1_max_marks') : ''; ?>">
                                      ...
                                      <!-- Subject 2 -->
                                      <tr>
                                          <th><input type="text" name="diploma_subject_2_name" id="diploma_subject_2_name" class="form-control font-weight-bold" placeholder="II year" value="II year" readonly></th>
                                          <td>
                                              <input type="number" name="diploma_subject_2_obtained_marks" id="diploma_subject_2_obtained_marks" class="form-control" placeholder="Enter Obtained Marks" value="<?php echo (set_value('diploma_subject_2_obtained_marks')) ? set_value('diploma_subject_2_obtained_marks') : ''; ?>">
                                              <span class="text-danger"><?php echo form_error('diploma_subject_2_obtained_marks'); ?></span>
                                          </td>
                                          <td>
                                              <input type="number" name="diploma_subject_2_max_marks" id="diploma_subject_2_max_marks" class="form-control" placeholder="Enter Max Marks" value="<?php echo (set_value('diploma_subject_2_max_marks')) ? set_value('diploma_subject_2_max_marks') : ''; ?>">
                                      ...
                                      <!-- Subject 3 -->
                                      <tr>
                                          <th><input type="text" name="diploma_subject_3_name" id="diploma_subject_3_name" class="form-control font-weight-bold" placeholder="III year" value="III year" readonly></th>
                                          <td>
                                              <input type="number" name="diploma_subject_3_obtained_marks" id="diploma_subject_3_obtained_marks" class="form-control" placeholder="Enter Obtained Marks" value="<?php echo (set_value('diploma_subject_3_obtained_marks')) ? set_value('diploma_subject_3_obtained_marks') : ''; ?>">
                                              <span class="text-danger"><?php echo form_error('diploma_subject_3_obtained_marks'); ?></span>
                                          </td>
                                          <td>
                                              <input type="number" name="diploma_subject_3_max_marks" id="diploma_subject_3_max_marks" class="form-control" placeholder="Enter Max Marks" value="<?php echo (set_value('diploma_subject_3_max_marks')) ? set_value('diploma_subject_3_max_marks') : ''; ?>">
                              ...
                              <div class="form-row">
                                  <div class="col-md-3 col-sm-6">
                                      <div class="form-group">
                                          <label class="label">Obtained Marks</label>
                                          <input type="text" name="diploma_total_obtained_marks" value="<?php echo (set_value('diploma_total_obtained_marks')) ? set_value('diploma_total_obtained_marks') : ''; ?>" id="diploma_total_obtained_marks" class="form-control" readonly>
                                  ...
                                  <div class="col-md-3 col-sm-6">
                                      <div class="form-group">
                                          <label class="label">Maximum Marks</label>
                                          <input type="text" name="diploma_total_max_marks" value="<?php echo (set_value('diploma_total_max_marks')) ? set_value('diploma_total_max_marks') : ''; ?>" id="diploma_total_max_marks" class="form-control" readonly>
                                  ...
                                  <div class="col-md-3 col-sm-6">
                                      <div class="form-group">
                                          <label class="label">Aggregate Percentage</label>
                                          <input type="text" name="diploma_aggregate" value="<?php echo (set_value('diploma_aggregate')) ? set_value('diploma_aggregate') : ''; ?>" id="diploma_aggregate" class="form-control" readonly>
                      ...
                      <?php } ?>
                      <?php if ($personalDetails->admission_based == "Diploma" && $personalDetails->lateral_entry == "GTTC") { ?>
                          <div class="card-body" id="card2">
                              ...
                              <div class="form-row">
                                  ...
                                  <div class="col-md-4 col-sm-6">
                                      <div class="form-group">
                                          <label class="label">Board / University</label>
                                          <input type="text" name="gt_inst_board" id="gt_inst_board" value="<?php echo (set_value('gt_inst_board')) ? set_value('gt_inst_board') : $gt_inst_board; ?>" class="form-control" placeholder="Enter Institution Board">
                                  ...
                                  <div class="col-md-4 col-sm-6">
                                      <div class="form-group">
                                          <label class="label">Institution Name</label>
                                          <input type="text" name="gt_inst_name" id="gt_inst_name" value="<?php echo (set_value('gt_inst_name')) ? set_value('gt_inst_name') : $gt_inst_name; ?>" class="form-control" placeholder="Enter Institution Name">
                              ...
                              <div class="form-row">
                                  <div class="col-md-3 col-sm-6">
                                      <div class="form-group">
                                          <label class="label">Institution Address</label>
                                          <input type="text" name="gt_inst_address" id="gt_inst_address" value="<?php echo (set_value('gt_inst_address')) ? set_value('gt_inst_address') : $gt_inst_address; ?>" class="form-control" placeholder="Enter Institution Address">
                                  ...
                                  <div class="col-md-3 col-sm-6">
                                      <div class="form-group">
                                          ...
                                          <select name="gt_inst_country" id="gt_inst_country" class="form-control input-lg select2">
                                              <option selected="">Select Country</option>
                                              <?php foreach ($countries as $country) : ?>
                                                  <option data-id="<?= $country->id ?>" value="<?= $country->name ?>"><?= $country->name ?></option>
                                              <?php endforeach; ?>
                              ...
                              <div class="form-row">
                                  ...
                                  <div class="col-md-3 col-sm-6">
                                      <div class="form-group">
                                          <label class="label">Year of Passing</label>
                                          <input type="month" name="gt_year_of_passing" value="<?php echo (set_value('gt_year_of_passing')) ? set_value('gt_year_of_passing') : $gt_year_of_passing; ?>" id="gt_year_of_passing" class="form-control" placeholder="Enter School Year">
                              ...
                              <table class="table" border="1">
                                  ...
                                  <tbody>
                                      <!-- Subject 1 -->
                                      <tr>
                                          <th><input type="text" name="gt_subject_1_name" id="gt_subject_1_name" class="form-control font-weight-bold" placeholder="I year" value="I year" readonly></th>
                                          <td>
                                              <input type="number" name="gt_subject_1_obtained_marks" id="gt_subject_1_obtained_marks" class="form-control" placeholder="Enter Obtained Marks" value="<?php echo (set_value('gt_subject_1_obtained_marks')) ? set_value('gt_subject_1_obtained_marks') : ''; ?>">
                                              <span class="text-danger"><?php echo form_error('gt_subject_1_obtained_marks'); ?></span>
                                          </td>
                                          <td>
                                              <input type="number" name="gt_subject_1_max_marks" id="gt_subject_1_max_marks" class="form-control" placeholder="Enter Max Marks" value="<?php echo (set_value('gt_subject_1_max_marks')) ? set_value('gt_subject_1_max_marks') : ''; ?>">
                                      ...
                                      <!-- Subject 2 -->
                                      <tr>
                                          <th><input type="text" name="gt_subject_2_name" id="gt_subject_2_name" class="form-control font-weight-bold" placeholder="II year" value="II year" readonly></th>
                                          <td>
                                              <input type="number" name="gt_subject_2_obtained_marks" id="gt_subject_2_obtained_marks" class="form-control" placeholder="Enter Obtained Marks" value="<?php echo (set_value('gt_subject_2_obtained_marks')) ? set_value('gt_subject_2_obtained_marks') : ''; ?>">
                                              <span class="text-danger"><?php echo form_error('gt_subject_2_obtained_marks'); ?></span>
                                          </td>
                                          <td>
                                              <input type="number" name="gt_subject_2_max_marks" id="gt_subject_2_max_marks" class="form-control" placeholder="Enter Max Marks" value="<?php echo (set_value('gt_subject_2_max_marks')) ? set_value('gt_subject_2_max_marks') : ''; ?>">
                                      ...
                                      <!-- Subject 3 -->
                                      <tr>
                                          <th><input type="text" name="gt_subject_3_name" id="gt_subject_3_name" class="form-control font-weight-bold" placeholder="III year" value="III year" readonly></th>
                                          <td>
                                              <input type="number" name="gt_subject_3_obtained_marks" id="gt_subject_3_obtained_marks" class="form-control" placeholder="Enter Obtained Marks" value="<?php echo (set_value('gt_subject_3_obtained_marks')) ? set_value('gt_subject_3_obtained_marks') : ''; ?>">
                                              <span class="text-danger"><?php echo form_error('gt_subject_3_obtained_marks'); ?></span>
                                          </td>
                                          <td>
                                              <input type="number" name="gt_subject_3_max_marks" id="gt_subject_3_max_marks" class="form-control" placeholder="Enter Max Marks" value="<?php echo (set_value('gt_subject_3_max_marks')) ? set_value('gt_subject_3_max_marks') : ''; ?>">
                                      ...
                                      <!-- Subject 4 -->
                                      <tr>
                                          <th><input type="text" name="gt_subject_4_name" id="gt_subject_4_name" class="form-control font-weight-bold" placeholder="IV year" value="IV year" readonly></th>
                                          <td>
                                              <input type="number" name="gt_subject_4_obtained_marks" id="gt_subject_4_obtained_marks" class="form-control" placeholder="Enter Obtained Marks" value="<?php echo (set_value('gt_subject_4_obtained_marks')) ? set_value('gt_subject_4_obtained_marks') : ''; ?>">
                                              <span class="text-danger"><?php echo form_error('gt_subject_4_obtained_marks'); ?></span>
                                          </td>
                                          <td>
                                              <input type="number" name="gt_subject_4_max_marks" id="gt_subject_4_max_marks" class="form-control" placeholder="Enter Max Marks" value="<?php echo (set_value('gt_subject_4_max_marks')) ? set_value('gt_subject_4_max_marks') : ''; ?>">
                              ...
                              <div class="form-row">
                                  <div class="col-md-3 col-sm-6">
                                      <div class="form-group">
                                          <label class="label">Obtained Marks</label>
                                          <input type="text" name="gt_total_obtained_marks" value="<?php echo (set_value('gt_total_obtained_marks')) ? set_value('gt_total_obtained_marks') : ''; ?>" id="gt_total_obtained_marks" class="form-control" readonly>
                                  ...
                                  <div class="col-md-3 col-sm-6">
                                      <div class="form-group">
                                          <label class="label">Maximum Marks</label>
                                          <input type="text" name="gt_total_max_marks" value="<?php echo (set_value('gt_total_max_marks')) ? set_value('gt_total_max_marks') : ''; ?>" id="gt_total_max_marks" class="form-control" readonly>
                                  ...
                                  <div class="col-md-3 col-sm-6">
                                      <div class="form-group">
                                          <label class="label">Aggregate Percentage</label>
                                          <input type="text" name="gt_aggregate" value="<?php echo (set_value('gt_aggregate')) ? set_value('gt_aggregate') : ''; ?>" id="gt_aggregate" class="form-control" readonly>
              ...
              $.ajax({
                  ...
                  success: function(response) {
                      ...
                      for (var i = 0; i < len; i++) {
                          var id = response[i]['id'];
                          var name = response[i]['name'];
                          $('#puc_inst_state').append("<option data-id='" + id + "' value='" + name + "'>" + name + "</option>");
                      }
                  }
              });
          });
              ...
              $.ajax({
                  ...
                  success: function(response) {
                      ...
                      for (var i = 0; i < len; i++) {
                          var id = response[i]['id'];
                          var name = response[i]['name'];
                          $('#puc_inst_city').append("<option value='" + name + "'>" + name + "</option>");
                      }
                  }
              });
          });
              ...
              $.ajax({
                  ...
                  success: function(response) {
                      ...
                      for (var i = 0; i < len; i++) {
                          var id = response[i]['id'];
                          var name = response[i]['name'];
                          $('#diploma_inst_state').append("<option data-id='" + id + "' value='" + name + "'>" + name + "</option>");
                      }
                  }
              });
          });
              ...
              $.ajax({
                  ...
                  success: function(response) {
                      ...
                      for (var i = 0; i < len; i++) {
                          var id = response[i]['id'];
                          var name = response[i]['name'];
                          $('#diploma_inst_city').append("<option value='" + name + "'>" + name + "</option>");
                      }
                  }
              });
          });
              ...
              $.ajax({
                  ...
                  success: function(response) {
                      ...
                      for (var i = 0; i < len; i++) {
                          var id = response[i]['id'];
                          var name = response[i]['name'];
                          $('#gt_inst_state').append("<option data-id='" + id + "' value='" + name + "'>" + name + "</option>");
                      }
                  }
              });
          });
              ...
              $.ajax({
                  ...
                  success: function(response) {
                      ...
                      for (var i = 0; i < len; i++) {
                          var id = response[i]['id'];
                          var name = response[i]['name'];
                          $('#gt_inst_city').append("<option value='" + name + "'>" + name + "</option>");
                      }
                  }
              });
          });
