                ...
                <div class="card-body" id="card2">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="form-group">
                                <label class="label">Board / University</label>
                                <input type="text" name="deg_inst_board" id="deg_inst_board"
                                    value="<?php echo (set_value('deg_inst_board')) ? set_value('deg_inst_board') : $deg_inst_board; ?>"
                                    class="form-control" placeholder="Enter Institution Board">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="form-group">
                                <label class="label">Institution Name</label>
                                <input type="text" name="deg_inst_name" id="deg_inst_name"
                                    value="<?php echo (set_value('deg_inst_name')) ? set_value('deg_inst_name') : $deg_inst_name; ?>"
                                    class="form-control" placeholder="Enter Institution Name">
                    ...
                    <div class="form-row">
                        <div class="col-md-3 col-sm-6">
                            <div class="form-group">
                                <label class="label">Institution Address</label>
                                <input type="text" name="deg_inst_address" id="deg_inst_address"
                                    value="<?php echo (set_value('deg_inst_address')) ? set_value('deg_inst_address') : $deg_inst_address; ?>"
                                    class="form-control" placeholder="Enter Institution Address">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="form-group">
                                ...
                                <select name="deg_inst_country" id="deg_inst_country"
                                    class="form-control input-lg select2">
                                    <option selected="">Select Country</option>
                                    <?php foreach ($countries as $country) : ?>
                                    <option data-id="<?= $country->id ?>" value="<?= $country->name ?>">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="form-group">
                                <label class="label">Register Number</label>
                                <input type="text" name="deg_register_number"
                                    value="<?php echo (set_value('deg_register_number')) ? set_value('deg_register_number') : $deg_register_number; ?>"
                                    id="deg_register_number" class="form-control" placeholder="Enter Register Number">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="form-group">
                                <label class="label">Year of Passing</label>
                                <input type="month" name="deg_year_of_passing"
                                    value="<?php echo (set_value('deg_year_of_passing')) ? set_value('deg_year_of_passing') : $deg_year_of_passing; ?>"
                                    id="deg_year_of_passing" class="form-control" placeholder="Enter School Year">
                    ...
                    <table class="table" border="1">
                        ...
                        <tbody>
                            <!-- Subject 1 -->
                            <tr>
                                <th><input type="text" name="deg_subject_1_name" id="deg_subject_1_name"
                                        class="form-control font-weight-bold" placeholder="I year" value="I year"
                                        readonly></th>
                                <td>
                                    <input type="number" name="deg_subject_1_obtained_marks"
                                        id="deg_subject_1_obtained_marks" class="form-control"
                                        placeholder="Enter Obtained Marks"
                                        value="<?php echo (set_value('deg_subject_1_obtained_marks')) ? set_value('deg_subject_1_obtained_marks') : ''; ?>">
                                    <span
                                        class="text-danger"><?php echo form_error('deg_subject_1_obtained_marks'); ?></span>
                                </td>
                                <td>
                                    <input type="number" name="deg_subject_1_max_marks" id="deg_subject_1_max_marks"
                                        class="form-control" placeholder="Enter Max Marks"
                                        value="<?php echo (set_value('deg_subject_1_max_marks')) ? set_value('deg_subject_1_max_marks') : ''; ?>">
                                    <span
                                        class="text-danger"><?php echo form_error('deg_subject_1_max_marks'); ?></span>
                                </td>
                                <td>
                                    <input type="text" readonly name="deg_subject_1_min_marks"
                                        id="deg_subject_1_min_marks" placeholder="Enter Percentage" class="form-control"
                                        value="<?php echo (set_value('deg_subject_1_min_marks')) ? set_value('deg_subject_1_min_marks') : ''; ?>">
                                    <span
                                        class="text-danger"><?php echo form_error('deg_subject_1_min_marks'); ?></span>
                                </td>
                            </tr>
                            <!-- Subject 2 -->
                            <tr>
                                <th><input type="text" name="deg_subject_2_name" id="deg_subject_2_name"
                                        class="form-control font-weight-bold" placeholder="II year" value="II year"
                                        readonly></th>
                                <td>
                                    <input type="number" name="deg_subject_2_obtained_marks"
                                        id="deg_subject_2_obtained_marks" class="form-control"
                                        placeholder="Enter Obtained Marks"
                                        value="<?php echo (set_value('deg_subject_2_obtained_marks')) ? set_value('deg_subject_2_obtained_marks') : ''; ?>">
                                    <span
                                        class="text-danger"><?php echo form_error('deg_subject_2_obtained_marks'); ?></span>
                                </td>
                                <td>
                                    <input type="number" name="deg_subject_2_max_marks" id="deg_subject_2_max_marks"
                                        class="form-control" placeholder="Enter Max Marks"
                                        value="<?php echo (set_value('deg_subject_2_max_marks')) ? set_value('deg_subject_2_max_marks') : ''; ?>">
                                    <span
                                        class="text-danger"><?php echo form_error('deg_subject_2_max_marks'); ?></span>
                                </td>
                                <td>
                                    <input type="text" readonly name="deg_subject_2_min_marks"
                                        id="deg_subject_2_min_marks" placeholder="Enter Percentage" class="form-control"
                                        value="<?php echo (set_value('deg_subject_2_min_marks')) ? set_value('deg_subject_2_min_marks') : ''; ?>">
                                    <span
                                        class="text-danger"><?php echo form_error('deg_subject_2_min_marks'); ?></span>
                                </td>
                            </tr>
                            <!-- Subject 3 -->
                            <tr>
                                <th><input type="text" name="deg_subject_3_name" id="deg_subject_3_name"
                                        class="form-control font-weight-bold" placeholder="III year" value="III year"
                                        readonly></th>
                                <td>
                                    <input type="number" name="deg_subject_3_obtained_marks"
                                        id="deg_subject_3_obtained_marks" class="form-control"
                                        placeholder="Enter Obtained Marks"
                                        value="<?php echo (set_value('deg_subject_3_obtained_marks')) ? set_value('deg_subject_3_obtained_marks') : ''; ?>">
                                    <span
                                        class="text-danger"><?php echo form_error('deg_subject_3_obtained_marks'); ?></span>
                                </td>
                                <td>
                                    <input type="number" name="deg_subject_3_max_marks" id="deg_subject_3_max_marks"
                                        class="form-control" placeholder="Enter Max Marks"
                                        value="<?php echo (set_value('deg_subject_3_max_marks')) ? set_value('deg_subject_3_max_marks') : ''; ?>">
                                    <span
                                        class="text-danger"><?php echo form_error('deg_subject_3_max_marks'); ?></span>
                                </td>
                                <td>
                                    <input type="text" readonly name="deg_subject_3_min_marks"
                                        id="deg_subject_3_min_marks" class="form-control" placeholder="Enter Percentage"
                                        value="<?php echo (set_value('deg_subject_3_min_marks')) ? set_value('deg_subject_3_min_marks') : ''; ?>">
                                    <span
                                        class="text-danger"><?php echo form_error('deg_subject_3_min_marks'); ?></span>
                                </td>
                            </tr>
                            <!-- Subject 4 -->
                            <tr>
                                <th><input type="text" name="deg_subject_4_name" id="deg_subject_4_name"
                                        class="form-control font-weight-bold" placeholder="IV year" value="IV year"
                                        readonly></th>
                                <td>
                                    <input type="number" name="deg_subject_4_obtained_marks"
                                        id="deg_subject_4_obtained_marks" class="form-control"
                                        placeholder="Enter Obtained Marks"
                                        value="<?php echo (set_value('deg_subject_4_obtained_marks')) ? set_value('deg_subject_4_obtained_marks') : ''; ?>">
                                    <span
                                        class="text-danger"><?php echo form_error('deg_subject_4_obtained_marks'); ?></span>
                                </td>
                                <td>
                                    <input type="number" name="deg_subject_4_max_marks" id="deg_subject_4_max_marks"
                                        class="form-control" placeholder="Enter Max Marks"
                                        value="<?php echo (set_value('deg_subject_4_max_marks')) ? set_value('deg_subject_4_max_marks') : ''; ?>">
                                    <span
                                        class="text-danger"><?php echo form_error('deg_subject_4_max_marks'); ?></span>
                                </td>
                                <td>
                                    <input type="text" readonly name="deg_subject_4_min_marks"
                                        id="deg_subject_4_min_marks" placeholder="Enter Percentage" class="form-control"
                                        value="<?php echo (set_value('deg_subject_4_min_marks')) ? set_value('deg_subject_4_min_marks') : ''; ?>">
                                    <span
                                        class="text-danger"><?php echo form_error('deg_subject_4_min_marks'); ?></span>
                                </td>
                            </tr>
                        </tbody>
                        <!-- <tfoot>
                    ...
                    <div class="form-row">
                        <div class="col-md-3 col-sm-6">
                            <div class="form-group">
                                <label class="label">Obtained Marks</label>
                                <input type="text" name="deg_total_obtained_marks"
                                    value="<?php echo (set_value('deg_total_obtained_marks')) ? set_value('deg_total_obtained_marks') : ''; ?>"
                                    id="deg_total_obtained_marks" class="form-control" readonly>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="form-group">
                                <label class="label">Maximum Marks</label>
                                <input type="text" name="deg_total_max_marks"
                                    value="<?php echo (set_value('deg_total_max_marks')) ? set_value('deg_total_max_marks') : ''; ?>"
                                    id="deg_total_max_marks" class="form-control" readonly>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="form-group">
                                <label class="label">Aggregate Percentage</label>
                                <input type="text" name="deg_aggregate"
                                    value="<?php echo (set_value('deg_aggregate')) ? set_value('deg_aggregate') : ''; ?>"
                                    id="deg_aggregate" class="form-control" readonly>
                ...
                <div class="card-body" id="card2">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="form-group">
                                <label class="label">Board / University</label>
                                <input type="text" name="mtech_inst_board" id="mtech_inst_board"
                                    value="<?php echo (set_value('mtech_inst_board')) ? set_value('mtech_inst_board') : $mtech_inst_board; ?>"
                                    class="form-control" placeholder="Enter Institution Board">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="form-group">
                                <label class="label">Institution Name</label>
                                <input type="text" name="mtech_inst_name" id="mtech_inst_name"
                                    value="<?php echo (set_value('mtech_inst_name')) ? set_value('mtech_inst_name') : $mtech_inst_name; ?>"
                                    class="form-control" placeholder="Enter Institution Name">
                    ...
                    <div class="form-row">
                        <div class="col-md-3 col-sm-6">
                            <div class="form-group">
                                <label class="label">Institution Address</label>
                                <input type="text" name="mtech_inst_address" id="mtech_inst_address"
                                    value="<?php echo (set_value('mtech_inst_address')) ? set_value('mtech_inst_address') : $mtech_inst_address; ?>"
                                    class="form-control" placeholder="Enter Institution Address">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="form-group">
                                ...
                                <select name="mtech_inst_country" id="mtech_inst_country"
                                    class="form-control input-lg select2">
                                    <option selected="">Select Country</option>
                                    <?php foreach ($countries as $country) : ?>
                                    <option data-id="<?= $country->id ?>" value="<?= $country->name ?>">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="form-group">
                                ...
                                <!-- <input type="text" name="diploma_inst_state" id="diploma_inst_state" class="form-control" placeholder="Enter Institution State"> -->
                                <select name="mtech_inst_state" id="mtech_inst_state"
                                    class="form-control input-lg select2">
                                    <option value="">Select State</option>
                                </select>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="form-group">
                                ...
                                <label class="label">Institution City</label>
                                <select name="mtech_inst_city" id="mtech_inst_city"
                                    class="form-control input-lg select2">
                                    <option value="">Select City</option>
                                </select>
                    ...
                    <div class="form-row">
                        <div class="col-md-3 col-sm-6">
                            <div class="form-group">
                                ...
                                <span
                                    class="text-danger"><?php echo form_error('mtech_medium_of_instruction'); ?></span>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6">
                            <div class="form-group">
                                <label class="label">Register Number</label>
                                <input type="text" name="mtech_register_number"
                                    value="<?php echo (set_value('mtech_register_number')) ? set_value('mtech_register_number') : $mtech_register_number; ?>"
                                    id="mtech_register_number" class="form-control" placeholder="Enter Register Number">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="form-group">
                                <label class="label">Year of Passing</label>
                                <input type="month" name="mtech_year_of_passing"
                                    value="<?php echo (set_value('mtech_year_of_passing')) ? set_value('mtech_year_of_passing') : $mtech_year_of_passing; ?>"
                                    id="mtech_year_of_passing" class="form-control" placeholder="Enter School Year">
                    ...
                    <table class="table" border="1">
                        ...
                        <tbody>
                            <!-- Subject 1 -->
                            <tr>
                                <th><input type="text" name="mtech_subject_1_name" id="mtech_subject_1_name"
                                        class="form-control font-weight-bold" placeholder="I year" value="I year"
                                        readonly></th>
                                <td>
                                    <input type="number" name="mtech_subject_1_obtained_marks"
                                        id="mtech_subject_1_obtained_marks" class="form-control"
                                        placeholder="Enter Obtained Marks"
                                        value="<?php echo (set_value('mtech_subject_1_obtained_marks')) ? set_value('mtech_subject_1_obtained_marks') : ''; ?>">
                                    <span
                                        class="text-danger"><?php echo form_error('mtech_subject_1_obtained_marks'); ?></span>
                                </td>
                                <td>
                                    <input type="number" name="mtech_subject_1_max_marks" id="mtech_subject_1_max_marks"
                                        class="form-control" placeholder="Enter Max Marks"
                                        value="<?php echo (set_value('mtech_subject_1_max_marks')) ? set_value('mtech_subject_1_max_marks') : ''; ?>">
                                    <span
                                        class="text-danger"><?php echo form_error('mtech_subject_1_max_marks'); ?></span>
                                </td>
                                <td>
                                    <input type="text" readonly name="mtech_subject_1_min_marks"
                                        id="mtech_subject_1_min_marks" placeholder="Enter Percentage"
                                        class="form-control"
                                        value="<?php echo (set_value('mtech_subject_1_min_marks')) ? set_value('mtech_subject_1_min_marks') : ''; ?>">
                                    <span
                                        class="text-danger"><?php echo form_error('mtech_subject_1_min_marks'); ?></span>
                                </td>
                            </tr>
                            <!-- Subject 2 -->
                            <tr>
                                <th><input type="text" name="mtech_subject_2_name" id="mtech_subject_2_name"
                                        class="form-control font-weight-bold" placeholder="II year" value="II year"
                                        readonly></th>
                                <td>
                                    <input type="number" name="mtech_subject_2_obtained_marks"
                                        id="mtech_subject_2_obtained_marks" class="form-control"
                                        placeholder="Enter Obtained Marks"
                                        value="<?php echo (set_value('mtech_subject_2_obtained_marks')) ? set_value('mtech_subject_2_obtained_marks') : ''; ?>">
                                    <span
                                        class="text-danger"><?php echo form_error('mtech_subject_2_obtained_marks'); ?></span>
                                </td>
                                <td>
                                    <input type="number" name="mtech_subject_2_max_marks" id="mtech_subject_2_max_marks"
                                        class="form-control" placeholder="Enter Max Marks"
                                        value="<?php echo (set_value('mtech_subject_2_max_marks')) ? set_value('mtech_subject_2_max_marks') : ''; ?>">
                                    <span
                                        class="text-danger"><?php echo form_error('diploma_subject_2_max_marks'); ?></span>
                                </td>
                                <td>
                                    <input type="text" readonly name="mtech_subject_2_min_marks"
                                        id="mtech_subject_2_min_marks" placeholder="Enter Percentage"
                                        class="form-control"
                                        value="<?php echo (set_value('mtech_subject_2_min_marks')) ? set_value('mtech_subject_2_min_marks') : ''; ?>">
                                    <span
                                        class="text-danger"><?php echo form_error('mtech_subject_2_min_marks'); ?></span>
                                </td>
                            </tr>
                            <!-- Subject 3 -->
                    ...
                    <div class="form-row">
                        <div class="col-md-3 col-sm-6">
                            <div class="form-group">
                                <label class="label">Obtained Marks</label>
                                <input type="text" name="mtech_total_obtained_marks"
                                    value="<?php echo (set_value('mtech_total_obtained_marks')) ? set_value('mtech_total_obtained_marks') : ''; ?>"
                                    id="mtech_total_obtained_marks" class="form-control" readonly>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="form-group">
                                <label class="label">Maximum Marks</label>
                                <input type="text" name="mtech_total_max_marks"
                                    value="<?php echo (set_value('mtech_total_max_marks')) ? set_value('mtech_total_max_marks') : ''; ?>"
                                    id="mtech_total_max_marks" class="form-control" readonly>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="form-group">
                                <label class="label">Aggregate Percentage</label>
                                <input type="text" name="mtech_aggregate"
                                    value="<?php echo (set_value('mtech_aggregate')) ? set_value('mtech_aggregate') : ''; ?>"
                                    id="mtech_aggregate" class="form-control" readonly>
                ...
                <div class="card-body" id="card2">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="form-group">
                                <label class="label">Board / University</label>
                                <input type="text" name="msc_inst_board" id="msc_inst_board"
                                    value="<?php echo (set_value('msc_inst_board')) ? set_value('msc_inst_board') : $msc_inst_board; ?>"
                                    class="form-control" placeholder="Enter Institution Board">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="form-group">
                                <label class="label">Institution Name</label>
                                <input type="text" name="msc_inst_name" id="msc_inst_name"
                                    value="<?php echo (set_value('msc_inst_name')) ? set_value('msc_inst_name') : $msc_inst_name; ?>"
                                    class="form-control" placeholder="Enter Institution Name">
                    ...
                    <div class="form-row">
                        <div class="col-md-3 col-sm-6">
                            <div class="form-group">
                                <label class="label">Institution Address</label>
                                <input type="text" name="msc_inst_address" id="msc_inst_address"
                                    value="<?php echo (set_value('msc_inst_address')) ? set_value('msc_inst_address') : $msc_inst_address; ?>"
                                    class="form-control" placeholder="Enter Institution Address">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="form-group">
                                ...
                                <select name="msc_inst_country" id="msc_inst_country"
                                    class="form-control input-lg select2">
                                    <option selected="">Select Country</option>
                                    <?php foreach ($countries as $country) : ?>
                                    <option data-id="<?= $country->id ?>" value="<?= $country->name ?>">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="form-group">
                                <label class="label">Register Number</label>
                                <input type="text" name="msc_register_number"
                                    value="<?php echo (set_value('msc_register_number')) ? set_value('msc_register_number') : $msc_register_number; ?>"
                                    id="msc_register_number" class="form-control" placeholder="Enter Register Number">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="form-group">
                                <label class="label">Year of Passing</label>
                                <input type="month" name="msc_year_of_passing"
                                    value="<?php echo (set_value('msc_year_of_passing')) ? set_value('msc_year_of_passing') : $msc_year_of_passing; ?>"
                                    id="msc_year_of_passing" class="form-control" placeholder="Enter School Year">
                    ...
                    <table class="table" border="1">
                        ...
                        <tbody>
                            <!-- Subject 1 -->
                            <tr>
                                <th><input type="text" name="msc_subject_1_name" id="msc_subject_1_name"
                                        class="form-control font-weight-bold" placeholder="I year" value="I year"
                                        readonly></th>
                                <td>
                                    <input type="number" name="msc_subject_1_obtained_marks"
                                        id="msc_subject_1_obtained_marks" class="form-control"
                                        placeholder="Enter Obtained Marks"
                                        value="<?php echo (set_value('msc_subject_1_obtained_marks')) ? set_value('msc_subject_1_obtained_marks') : ''; ?>">
                                    <span
                                        class="text-danger"><?php echo form_error('msc_subject_1_obtained_marks'); ?></span>
                                </td>
                                <td>
                                    <input type="number" name="msc_subject_1_max_marks" id="msc_subject_1_max_marks"
                                        class="form-control" placeholder="Enter Max Marks"
                                        value="<?php echo (set_value('msc_subject_1_max_marks')) ? set_value('msc_subject_1_max_marks') : ''; ?>">
                                    <span
                                        class="text-danger"><?php echo form_error('msc_subject_1_max_marks'); ?></span>
                                </td>
                                <td>
                                    <input type="text" readonly name="msc_subject_1_min_marks"
                                        id="msc_subject_1_min_marks" placeholder="Enter Percentage" class="form-control"
                                        value="<?php echo (set_value('msc_subject_1_min_marks')) ? set_value('msc_subject_1_min_marks') : ''; ?>">
                                    <span
                                        class="text-danger"><?php echo form_error('msc_subject_1_min_marks'); ?></span>
                                </td>
                            </tr>
                            <!-- Subject 2 -->
                            <tr>
                                <th><input type="text" name="msc_subject_2_name" id="msc_subject_2_name"
                                        class="form-control font-weight-bold" placeholder="II year" value="II year"
                                        readonly></th>
                                <td>
                                    <input type="number" name="msc_subject_2_obtained_marks"
                                        id="msc_subject_2_obtained_marks" class="form-control"
                                        placeholder="Enter Obtained Marks"
                                        value="<?php echo (set_value('msc_subject_2_obtained_marks')) ? set_value('msc_subject_2_obtained_marks') : ''; ?>">
                                    <span
                                        class="text-danger"><?php echo form_error('msc_subject_2_obtained_marks'); ?></span>
                                </td>
                                <td>
                                    <input type="number" name="msc_subject_2_max_marks" id="msc_subject_2_max_marks"
                                        class="form-control" placeholder="Enter Max Marks"
                                        value="<?php echo (set_value('msc_subject_2_max_marks')) ? set_value('msc_subject_2_max_marks') : ''; ?>">
                                    <span
                                        class="text-danger"><?php echo form_error('msc_subject_2_max_marks'); ?></span>
                                </td>
                                <td>
                                    <input type="text" readonly name="msc_subject_2_min_marks"
                                        id="msc_subject_2_min_marks" placeholder="Enter Percentage" class="form-control"
                                        value="<?php echo (set_value('msc_subject_2_min_marks')) ? set_value('msc_subject_2_min_marks') : ''; ?>">
                                    <span
                                        class="text-danger"><?php echo form_error('msc_subject_2_min_marks'); ?></span>
                                </td>
                            </tr>
                            <!-- Subject 3 -->
                    ...
                    <div class="form-row">
                        <div class="col-md-3 col-sm-6">
                            <div class="form-group">
                                <label class="label">Obtained Marks</label>
                                <input type="text" name="msc_total_obtained_marks"
                                    value="<?php echo (set_value('msc_total_obtained_marks')) ? set_value('msc_total_obtained_marks') : ''; ?>"
                                    id="msc_total_obtained_marks" class="form-control" readonly>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="form-group">
                                <label class="label">Maximum Marks</label>
                                <input type="text" name="msc_total_max_marks"
                                    value="<?php echo (set_value('msc_total_max_marks')) ? set_value('msc_total_max_marks') : ''; ?>"
                                    id="msc_total_max_marks" class="form-control" readonly>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="form-group">
                                <label class="label">Aggregate Percentage</label>
                                <input type="text" name="msc_aggregate"
                                    value="<?php echo (set_value('msc_aggregate')) ? set_value('msc_aggregate') : ''; ?>"
                                    id="msc_aggregate" class="form-control" readonly>
                ...
                <div class="card-body" id="card2">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="form-group">
                                <label class="label">Board / University</label>
                                <input type="text" name="mscegg_inst_board" id="mscegg_inst_board"
                                    value="<?php echo (set_value('mscegg_inst_board')) ? set_value('mscegg_inst_board') : $mscegg_inst_board; ?>"
                                    class="form-control" placeholder="Enter Institution Board">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="form-group">
                                <label class="label">Institution Name</label>
                                <input type="text" name="mscegg_inst_name" id="mscegg_inst_name"
                                    value="<?php echo (set_value('mscegg_inst_name')) ? set_value('mscegg_inst_name') : $mscegg_inst_name; ?>"
                                    class="form-control" placeholder="Enter Institution Name">
                    ...
                    <div class="form-row">
                        <div class="col-md-3 col-sm-6">
                            <div class="form-group">
                                <label class="label">Institution Address</label>
                                <input type="text" name="mscegg_inst_address" id="mscegg_inst_address"
                                    value="<?php echo (set_value('mscegg_inst_address')) ? set_value('mscegg_inst_address') : $mscegg_inst_address; ?>"
                                    class="form-control" placeholder="Enter Institution Address">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="form-group">
                                ...
                                <select name="mscegg_inst_country" id="mscegg_inst_country"
                                    class="form-control input-lg select2">
                                    <option selected="">Select Country</option>
                                    <?php foreach ($countries as $country) : ?>
                                    <option data-id="<?= $country->id ?>" value="<?= $country->name ?>">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="form-group">
                                ...
                                <!-- <input type="text" name="diploma_inst_state" id="diploma_inst_state" class="form-control" placeholder="Enter Institution State"> -->
                                <select name="mscegg_inst_state" id="mscegg_inst_state"
                                    class="form-control input-lg select2">
                                    <option value="">Select State</option>
                                </select>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="form-group">
                                ...
                                <label class="label">Institution City</label>
                                <select name="mscegg_inst_city" id="mscegg_inst_city"
                                    class="form-control input-lg select2">
                                    <option value="">Select City</option>
                                </select>
                    ...
                    <div class="form-row">
                        <div class="col-md-3 col-sm-6">
                            <div class="form-group">
                                ...
                                <span
                                    class="text-danger"><?php echo form_error('mscegg_medium_of_instruction'); ?></span>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6">
                            <div class="form-group">
                                <label class="label">Register Number</label>
                                <input type="text" name="mscegg_register_number"
                                    value="<?php echo (set_value('mscegg_register_number')) ? set_value('mscegg_register_number') : $mscegg_register_number; ?>"
                                    id="mscegg_register_number" class="form-control"
                                    placeholder="Enter Register Number">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="form-group">
                                <label class="label">Year of Passing</label>
                                <input type="month" name="mscegg_year_of_passing"
                                    value="<?php echo (set_value('mscegg_year_of_passing')) ? set_value('mscegg_year_of_passing') : $mscegg_year_of_passing; ?>"
                                    id="mscegg_year_of_passing" class="form-control" placeholder="Enter School Year">
                    ...
                    <table class="table" border="1">
                        ...
                        <tbody>
                            <!-- Subject 1 -->
                            <tr>
                                <th><input type="text" name="mscegg_subject_1_name" id="mscegg_subject_1_name"
                                        class="form-control font-weight-bold" placeholder="I year" value="I year"
                                        readonly></th>
                                <td>
                                    <input type="number" name="mscegg_subject_1_obtained_marks"
                                        id="mscegg_subject_1_obtained_marks" class="form-control"
                                        placeholder="Enter Obtained Marks"
                                        value="<?php echo (set_value('mscegg_subject_1_obtained_marks')) ? set_value('mscegg_subject_1_obtained_marks') : ''; ?>">
                                    <span
                                        class="text-danger"><?php echo form_error('mscegg_subject_1_obtained_marks'); ?></span>
                                </td>
                                <td>
                                    <input type="number" name="mscegg_subject_1_max_marks"
                                        id="mscegg_subject_1_max_marks" class="form-control"
                                        placeholder="Enter Max Marks"
                                        value="<?php echo (set_value('mscegg_subject_1_max_marks')) ? set_value('mscegg_subject_1_max_marks') : ''; ?>">
                                    <span
                                        class="text-danger"><?php echo form_error('mscegg_subject_1_max_marks'); ?></span>
                                </td>
                                <td>
                                    <input type="text" readonly name="mscegg_subject_1_min_marks"
                                        id="mscegg_subject_1_min_marks" placeholder="Enter Percentage"
                                        class="form-control"
                                        value="<?php echo (set_value('mscegg_subject_1_min_marks')) ? set_value('mscegg_subject_1_min_marks') : ''; ?>">
                                    <span
                                        class="text-danger"><?php echo form_error('mscegg_subject_1_min_marks'); ?></span>
                                </td>
                            </tr>
                            <!-- Subject 2 -->
                            <tr>
                                <th><input type="text" name="mscegg_subject_2_name" id="mscegg_subject_2_name"
                                        class="form-control font-weight-bold" placeholder="II year" value="II year"
                                        readonly></th>
                                <td>
                                    <input type="number" name="mscegg_subject_2_obtained_marks"
                                        id="mscegg_subject_2_obtained_marks" class="form-control"
                                        placeholder="Enter Obtained Marks"
                                        value="<?php echo (set_value('mscegg_subject_2_obtained_marks')) ? set_value('mscegg_subject_2_obtained_marks') : ''; ?>">
                                    <span
                                        class="text-danger"><?php echo form_error('mscegg_subject_2_obtained_marks'); ?></span>
                                </td>
                                <td>
                                    <input type="number" name="mscegg_subject_2_max_marks"
                                        id="mscegg_subject_2_max_marks" class="form-control"
                                        placeholder="Enter Max Marks"
                                        value="<?php echo (set_value('mscegg_subject_2_max_marks')) ? set_value('mscegg_subject_2_max_marks') : ''; ?>">
                                    <span
                                        class="text-danger"><?php echo form_error('mscegg_subject_2_max_marks'); ?></span>
                                </td>
                                <td>
                                    <input type="text" readonly name="mscegg_subject_2_min_marks"
                                        id="mscegg_subject_2_min_marks" placeholder="Enter Percentage"
                                        class="form-control"
                                        value="<?php echo (set_value('mscegg_subject_2_min_marks')) ? set_value('mscegg_subject_2_min_marks') : ''; ?>">
                                    <span
                                        class="text-danger"><?php echo form_error('mscegg_subject_2_min_marks'); ?></span>
                                </td>
                            </tr>
                            <!-- Subject 3 -->
                            <tr>
                                <th><input type="text" name="mscegg_subject_3_name" id="mscegg_subject_3_name"
                                        class="form-control font-weight-bold" placeholder="III year" value="III year"
                                        readonly></th>
                                <td>
                                    <input type="number" name="mscegg_subject_3_obtained_marks"
                                        id="mscegg_subject_3_obtained_marks" class="form-control"
                                        placeholder="Enter Obtained Marks"
                                        value="<?php echo (set_value('mscegg_subject_3_obtained_marks')) ? set_value('mscegg_subject_3_obtained_marks') : ''; ?>">
                                    <span
                                        class="text-danger"><?php echo form_error('mscegg_subject_3_obtained_marks'); ?></span>
                                </td>
                                <td>
                                    <input type="number" name="mscegg_subject_3_max_marks"
                                        id="mscegg_subject_3_max_marks" class="form-control"
                                        placeholder="Enter Max Marks"
                                        value="<?php echo (set_value('mscegg_subject_3_max_marks')) ? set_value('mscegg_subject_3_max_marks') : ''; ?>">
                                    <span
                                        class="text-danger"><?php echo form_error('mscegg_subject_3_max_marks'); ?></span>
                                </td>
                                <td>
                                    <input type="text" readonly name="mscegg_subject_3_min_marks"
                                        id="mscegg_subject_3_min_marks" placeholder="Enter Percentage"
                                        class="form-control"
                                        value="<?php echo (set_value('mscegg_subject_3_min_marks')) ? set_value('mscegg_subject_3_min_marks') : ''; ?>">
                                    <span
                                        class="text-danger"><?php echo form_error('mscegg_subject_3_min_marks'); ?></span>
                                </td>
                            </tr>
                    ...
                    <div class="form-row">
                        <div class="col-md-3 col-sm-6">
                            <div class="form-group">
                                <label class="label">Obtained Marks</label>
                                <input type="text" name="mscegg_total_obtained_marks"
                                    value="<?php echo (set_value('mscegg_total_obtained_marks')) ? set_value('mscegg_total_obtained_marks') : ''; ?>"
                                    id="mscegg_total_obtained_marks" class="form-control" readonly>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="form-group">
                                <label class="label">Maximum Marks</label>
                                <input type="text" name="mscegg_total_max_marks"
                                    value="<?php echo (set_value('mscegg_total_max_marks')) ? set_value('mscegg_total_max_marks') : ''; ?>"
                                    id="mscegg_total_max_marks" class="form-control" readonly>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="form-group">
                                <label class="label">Aggregate Percentage</label>
                                <input type="text" name="mscegg_aggregate"
                                    value="<?php echo (set_value('mscegg_aggregate')) ? set_value('mscegg_aggregate') : ''; ?>"
                                    id="mscegg_aggregate" class="form-control" readonly>
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                for (var i = 0; i < len; i++) {
                    var id = response[i]['id'];
                    var name = response[i]['name'];
                    $('#msc_inst_state').append("<option data-id='" + id + "' value='" +
                        name + "'>" + name + "</option>");
                }
            }
        });
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                for (var i = 0; i < len; i++) {
                    var id = response[i]['id'];
                    var name = response[i]['name'];
                    $('#msc_inst_city').append("<option value='" + name + "'>" + name +
                        "</option>");
                }
            }
        });
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                for (var i = 0; i < len; i++) {
                    var id = response[i]['id'];
                    var name = response[i]['name'];
                    $('#mscegg_inst_state').append("<option data-id='" + id + "' value='" +
                        name + "'>" + name + "</option>");
                }
            }
        });
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                for (var i = 0; i < len; i++) {
                    var id = response[i]['id'];
                    var name = response[i]['name'];
                    $('#mscegg_inst_city').append("<option value='" + name + "'>" + name +
                        "</option>");
                }
            }
        });
