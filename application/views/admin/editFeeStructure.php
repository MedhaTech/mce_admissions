...
<div class="card shadow mb-4">
  <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
      <h6 class="m-0 font-weight-bold text-primary">Edit Fee Structure</h6>
  </div>
  <?php echo form_open('admin/editFeeStructure/' . $fee_structure['id']); 
    
  ?>
  <div class="card-body">
   
      <form action="" class="user" enctype="multipart/form-data" method="post" accept-charset="utf-8">
        
        
          <div class="col-md-8 offset-1">    
            
          <div class="form-group row">
             <label for="staticEmail" class="col-md-5 col-form-label text-right">E Learning Fee</label>
              <div class="col-md-7">
          ...
          <div class="form-group row">
             <label for="staticEmail" class="col-md-5 col-form-label text-right">Eligibility Fee</label>
              <div class="col-md-7">
          ...
          <div class="form-group row">
             <label for="staticEmail" class="col-md-5 col-form-label text-right">e Consortium Fee</label>
              <div class="col-md-7">
                  <input type="text" name="e_consortium_fee" id="e_consortium_fee" class="form-control" value="<?php echo (set_value('e_consortium_fee'))?set_value('e_consortium_fee'):$fee_structure['e_consortium_fee'];?>">
                   <span class="text-danger"></span>
                                ...
                                <div class="form-group row">
                      <label for="staticEmail" class="col-md-5 col-form-label text-right">Sport Fee</label>
                      <div class="col-md-7">
                        ...
                        <span class="text-danger"></span>
                                ...
                                <div class="form-group row">
                      <label for="staticEmail" class="col-md-5 col-form-label text-right">Sports Development fee</label>
                      <div class="col-md-7">
                        ...
                        <span class="text-danger"></span>
                                ...
                                <div class="form-group row">
                      <label for="staticEmail" class="col-md-5 col-form-label text-right">Career Guidance & Counseling fee</label>
                      <div class="col-md-7">
                        ...
                        <span class="text-danger"></span>
                                ...
                                <div class="form-group row">
                      <label for="staticEmail" class="col-md-5 col-form-label text-right">University Development fund</label>
                      <div class="col-md-7">
                        ...
                        <span class="text-danger"></span>
                                ...
                                <div class="form-group row">
                      <label for="staticEmail" class="col-md-5 col-form-label text-right">Promotion of indian Cultural Activities Fee</label>
                      <div class="col-md-7">
                        ...
                        <span class="text-danger"></span>
                                ...
                                <div class="form-group row">
                      <label for="staticEmail" class="col-md-5 col-form-label text-right">Teachers Development Fee</label>
                      <div class="col-md-7">
                        ...
                        <span class="text-danger"></span>
                                ...
                                <div class="form-group row">
                      <label for="staticEmail" class="col-md-5 col-form-label text-right">Student Development Fee</label>
                      <div class="col-md-7">
                        ...
                        <span class="text-danger"></span>
                                ...
                                <div class="form-group row">
                      <label for="staticEmail" class="col-md-5 col-form-label text-right">Indian Red Cross Membership Fee</label>
                      <div class="col-md-7">
                        ...
                        <span class="text-danger"></span>
                                ...
                                <div class="form-group row">
                      <label for="staticEmail" class="col-md-5 col-form-label text-right">Women Cell Fee</label>
                      <div class="col-md-7">
                        ...
                        <span class="text-danger"></span>
                                ...
                                <div class="form-group row">
                      <label for="staticEmail" class="col-md-5 col-form-label text-right">NSS Fee</label>
                      <div class="col-md-7">
                        ...
                        <span class="text-danger"></span>
                                ...
                                <div class="form-group row">
                      <label for="staticEmail" class="col-md-5 col-form-label text-right">University Registration Fee</label>
                      <div class="col-md-7">
            ...
            <div class="form-group row">
              <label for="staticEmail" class="col-md-5 col-form-label text-right font-weight-bold">TOTAL UNIVERSITY FEE</label>
              <div class="col-md-7">
                  <input type="text" name="total_university_fee" id="total_university_fee" class="form-control" value="<?php echo (set_value('total_university_fee'))?set_value('total_university_fee'):$fee_structure['total_university_fee'];?>" readonly>
                  <span class="text-danger"></span>
              </div>
            </div>
            
            <div class="form-group row">
              <label for="staticEmail" class="col-md-12 col-form-label text-right font-weight-bold"><hr/></label>
            </div>
                  <div class="form-group row">
                      <label for="staticEmail" class="col-md-5 col-form-label text-right">Admission fee</label>
                      <div class="col-md-7">
                  ...
                  <div class="form-group row">
                      <label for="staticEmail" class="col-md-5 col-form-label text-right">Processing Fee paid at KEA</label>
                      <div class="col-md-7">
                  ...
                  <div class="form-group row">
                      <label for="staticEmail" class="col-md-5 col-form-label text-right">Tution Fee</label>
                      <div class="col-md-7">
                  ...
                  <div class="form-group row">
                      <label for="staticEmail" class="col-md-5 col-form-label text-right">COLLEGE  OTHER FEE</label>
                      <div class="col-md-7">
            ...
            <div class="form-group row">
              <label for="staticEmail" class="col-md-5 col-form-label text-right font-weight-bold">TOTAL TUTION FEE</label>
              <div class="col-md-7">
                  <input type="text" name="total_tution_fee" id="total_tution_fee" class="form-control" value="<?php echo (set_value('total_tution_fee'))?set_value('total_tution_fee'):$fee_structure['total_tution_fee'];?>" readonly>
                  <span class="text-danger"></span>
              </div>
            </div>
            ...
            <div class="form-group row">
              <label for="staticEmail" class="col-md-5 col-form-label text-right font-weight-bold">TOTAL DEMAND</label>
              <div class="col-md-7">
                  <input type="text" name="total_demand" id="total_demand" class="form-control" value="<?php echo (set_value('total_demand'))?set_value('total_demand'):$fee_structure['total_demand'];?>" readonly>
                  <span class="text-danger"></span>
              </div>
            </div>
            <hr/>
            <div class="form-group row">
              <label for="staticEmail" class="col-md-5 col-form-label text-right font-weight-bold">SKILL DEVELOPMENT FEE</label>
              <div class="col-md-7">
            ...
            <div class="form-group row">
              <label for="staticEmail" class="col-md-5 col-form-label text-right font-weight-bold">CORPUS FUND</label>
              <div class="col-md-7">
...
$(document).ready(function(){
  ...
  function calFeeTotal(){
      ...
      var promotion_of_indian_cultural_activities_fee = parseInt($('#promotion_of_indian_cultural_activities_fee').val());
      ...
      var total_university_fee = e_learning_fee + eligibility_fee + e_consortium_fee + sport_fee + sports_development_fee + career_guidance_counseling_fee + university_development_fund + promotion_of_indian_cultural_activities_fee + teachers_development_fee + student_development_fee + indian_red_cross_membership_fee + women_cell_fee + nss_fee + university_registration_fee
      
      var admission_fee = parseInt($('#admission_fee').val());
      var processing_fee_paid_at_kea = parseInt($('#processing_fee_paid_at_keaadmission_fee').val());
